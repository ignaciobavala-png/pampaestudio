      ...
      <header className="flex shrink-0 items-start justify-between px-[22px] pb-3 pt-[max(16px,env(safe-area-inset-top))]">
        <div>
          <div className="font-serif text-[21px] tracking-[-0.01em] leading-none">
            Pampa
            <span className="ml-0.5 inline-block size-[5px] rounded-full bg-[linear-gradient(135deg,#D7D9E0,#F4F5F8,#C2C4CE)] align-middle" />
          </div>
          <div className="mt-px text-[10px] font-medium tracking-[0.14em] uppercase text-ink-dim">
            Pilates & Yoga
          </div>
        </div>
        <Link
